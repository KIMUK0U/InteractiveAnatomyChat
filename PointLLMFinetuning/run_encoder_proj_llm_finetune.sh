...
PRETRAINED_PATH="/home/yyamashita/Desktop/kkimu/test/ProjectionFinetuning/outputs/encoder_proj_tune_v9_demo_dental_model_32_final/checkpoints/best_model"
...
# コマンド構築
CMD="python encoder_proj_llm_finetune.py --gpu 0 --pointllm-path $POINTLLM_DIR --pretrained-path $PRETRAINED_PATH"
